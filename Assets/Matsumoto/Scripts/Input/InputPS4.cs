...
public static class InputPS4 {
	...
	public static float GetTrigger(GamePad.Trigger trigger, GamePad.Index controlIndex, bool raw = false) {
		...
		if(trigger == GamePad.Trigger.LeftTrigger) {
			name = "R_JoyStick" + (int)controlIndex + "_XAxis";
		}
		else if(trigger == GamePad.Trigger.RightTrigger) {
			name = "R_JoyStick" + (int)controlIndex + "_YAxis";
		}
	...
	static KeyCode GetKeycode(GamePad.Button button, GamePad.Index controlIndex) {
		switch(controlIndex) {
			case GamePad.Index.One:
				switch(button) {
					case GamePad.Button.A: return KeyCode.Joystick1Button1;
					case GamePad.Button.B: return KeyCode.Joystick1Button2;
					case GamePad.Button.X: return KeyCode.Joystick1Button0;
					...
					case GamePad.Button.Back: return KeyCode.Joystick1Button8;
					case GamePad.Button.Start: return KeyCode.Joystick1Button9;
					case GamePad.Button.LeftStick: return KeyCode.Joystick1Button10;
					case GamePad.Button.RightStick: return KeyCode.Joystick1Button11;
				}
				break;
			case GamePad.Index.Two:
				switch(button) {
					case GamePad.Button.A: return KeyCode.Joystick2Button1;
					case GamePad.Button.B: return KeyCode.Joystick2Button2;
					case GamePad.Button.X: return KeyCode.Joystick2Button0;
					...
					case GamePad.Button.Back: return KeyCode.Joystick2Button8;
					case GamePad.Button.Start: return KeyCode.Joystick2Button9;
					case GamePad.Button.LeftStick: return KeyCode.Joystick2Button10;
					case GamePad.Button.RightStick: return KeyCode.Joystick2Button11;
				}
				break;
			case GamePad.Index.Three:
				switch(button) {
					case GamePad.Button.A: return KeyCode.Joystick3Button1;
					case GamePad.Button.B: return KeyCode.Joystick3Button2;
					case GamePad.Button.X: return KeyCode.Joystick3Button0;
					...
					case GamePad.Button.Back: return KeyCode.Joystick3Button8;
					case GamePad.Button.Start: return KeyCode.Joystick3Button9;
					case GamePad.Button.LeftStick: return KeyCode.Joystick3Button10;
					case GamePad.Button.RightStick: return KeyCode.Joystick3Button11;
				}
				break;
			case GamePad.Index.Four:

				switch(button) {
					case GamePad.Button.A: return KeyCode.Joystick4Button1;
					case GamePad.Button.B: return KeyCode.Joystick4Button2;
					case GamePad.Button.X: return KeyCode.Joystick4Button0;
					...
					case GamePad.Button.Back: return KeyCode.Joystick4Button8;
					case GamePad.Button.Start: return KeyCode.Joystick4Button9;
					case GamePad.Button.LeftStick: return KeyCode.Joystick4Button10;
					case GamePad.Button.RightStick: return KeyCode.Joystick4Button11;
				}
				break;
		}
		return KeyCode.None;
